                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="country" action="show" id="${cityInstance?.country?.id}">${cityInstance?.country?.encodeAsHTML()}</g:link></td>
