...
<body>
	...
	<div id="content">
		...
		<div id="main">
			...
			<div class="simple">
			 	<h2 class="no-border"><g:message code="default.edit.label" args="[entityName]" /> </h2>
            ...
            <g:form name="createFrm" action="update" useToken="true">
                        ...
                        <tbody>
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="jobpromo.title.label" default="Title" /></label>
                                </td>
                            ...
                            <tr class="prop">
                               ...
                               <td valign="top" class="value ${hasErrors(bean: jobPromoInstance, field: 'type', 'errors')}">
                                    ...
                                    optionKey="id"  optionValue="name" value="${jobPromoInstance.type }"  />
                                </td>
                              </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="country.id"><g:message code="country.label" default="Country" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: jobPromoInstance, field: 'country', 'errors')}">
                                    <g:select id="country.id" name="country.id" noSelection="['':'Please select country']" from="${joberty.dic.Country.list()}" optionKey="id"  optionValue="name" value="${jobPromoInstance.country?.id }"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="size"><g:message code="jobpromo.startDate.label" default="Job start date" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="status"><g:message code="jobpromo.type.label" default="Promotion status" /></label>
                                </td>
                               <td valign="top" class="value ${hasErrors(bean: jobPromoInstance, field: 'status', 'errors')}">
                                    <g:select id="status" name="status" noSelection="['':'Please select status of promotion']" 
                                    from="[[id:JobPromo.STATUS_CREATED, name:'created'],
                                           [id:JobPromo.STATUS_PUBLISHED, name:'published']]" 
                                    optionKey="id"  optionValue="name" value="${jobPromoInstance.status}"  />
                                </td>
                              </tr>
